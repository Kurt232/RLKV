...
class MultiplePasskeyRetrievalDataset(Dataset):
    ...
    def __init__(
        ...
        prompt1="This is a very long story book: <book> ",
        prompt2=" </book>.\n\n",
        buffer_size=300,
        separator="\n\n",
        min_depth_ratio=0.1,
        ...
        self.separator_tokens = self.tokenizer.encode(
    ...
    def _construct_input(self, context_tokens, passkey_tokens_list):
        ...
        for i, (passkey_tokens, retrieval_question_tokens) in enumerate(
            ...
            qa_tokens += (
                retrieval_question_tokens + passkey_tokens + self.separator_tokens
            )
